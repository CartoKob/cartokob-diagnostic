...
{key:'gpuDoc',title:'Document d’urbanisme opposable',source:'IGN · GPU',scope:'Au point',url:carto+'gpu/document?geom='+geom,parse:featureList},
{key:'scot',title:'SCoT',source:'IGN · GPU',scope:'Au point',url:carto+'gpu/scot?geom='+geom,parse:featureList},
...
{key:'ppr',title:'Plans de prévention des risques',source:'Géorisques · GASPAR',scope:'À l’échelle de la commune',url:'https://www.georisques.gouv.fr/api/v1/gaspar/ppr?code_insee='+code,parse:pprList},
