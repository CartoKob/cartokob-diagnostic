...
await copyFile('server/water-api.js','dist/server/water-api.js');
...
export default {async fetch(request,env,ctx){return await handleWaterRequest(request)||await handleMarketRequest(request)||assets.fetch(request,env,ctx);}};
`);
